...
from my_blog.AdminUser import AdminUser
...
@view_config(context='my_blog:resources.Admin', name='', renderer='my_blog:templates/admin.pt', permission='admin')
...
@view_config(context='pyramid.httpexceptions.HTTPForbidden', renderer='my_blog:templates/login.pt')
@view_config(context='my_blog:resources.Admin', name='login', renderer='my_blog:templates/login.pt')
def login(context, request):
    url = ''
    if request.scheme == 'http':
        request.scheme = 'https'
        #return HTTPFound(location=request.url)
    return {'message': 'login', 'cur_page': '', 'page_title': 'Welcome to Christian\'s Blog', 'url': url}


@view_config(context='my_blog:resources.Admin', name='login',  request_method='POST', renderer='my_blog:templates/login.pt')
...
@view_config(context='my_blog:resources.Admin', name='logout', renderer='my_blog:templates/admin.pt')
...
@view_config(context='my_blog:resources.Admin',  renderer='json', xhr=True, permission='admin')
        ...
        if request.params['action_type'] == 'add':
            for key, value in request.params.items():
                ...
                if key != 'postBlog' or key != 'action_type':
                    post_data[key] = value
            post_data['author'] = 'Christian Murphy'
...
@view_config(context='my_blog:resources.Admin', name='pages',  renderer='json', xhr=True, permission='admin')
...
#handle all the CRUD actions on the backend
@view_config(context='my_blog:resources.Admin',  name='delete', request_method='DELETE', renderer='json', xhr=True, permission='admin')
