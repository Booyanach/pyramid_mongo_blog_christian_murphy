...
import logging
from my_blog.resources import Root
...
def main(global_config, **settings):
    ...
    config.add_static_view('static', 'my_blog:static')
    ...
    def inject_renderer_globals(event):
        ...
        event['static_info'] = {'blog_title': 'Christian Codes', 'site_motto': 'Programming Blog of Christian Murphy'}
